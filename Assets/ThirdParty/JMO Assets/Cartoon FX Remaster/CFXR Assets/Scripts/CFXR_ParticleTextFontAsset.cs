...
namespace JMO_Assets.Cartoon_FX_Remaster.CFXR_Assets.Scripts
{
	public class CFXR_ParticleTextFontAsset : ScriptableObject
	{
		...
		public bool IsValid()
		{
			var valid = !string.IsNullOrEmpty(CharSequence) && CharSprites != null && CharSprites.Length == CharSequence.Length && CharKerningOffsets != null && CharKerningOffsets.Length == CharSprites.Length;

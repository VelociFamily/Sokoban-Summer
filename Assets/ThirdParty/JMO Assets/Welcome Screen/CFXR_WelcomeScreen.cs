...
namespace JMO_Assets.Welcome_Screen
{
    ...
    public class CFXR_WelcomeScreen : EditorWindow
    {
        ...
        private void CreateGUI()
        {
            ...
            // Buttons
            root.Q<Label>("btn_cfxr1").AddManipulator(new Clickable(_ => { Application.OpenURL("https://assetstore.unity.com/packages/slug/4010"); }));
            root.Q<Label>("btn_cfxr2").AddManipulator(new Clickable(_ => { Application.OpenURL("https://assetstore.unity.com/packages/slug/4274"); }));
            root.Q<Label>("btn_cfxr3").AddManipulator(new Clickable(_ => { Application.OpenURL("https://assetstore.unity.com/packages/slug/10172"); }));
            root.Q<Label>("btn_cfxr4").AddManipulator(new Clickable(_ => { Application.OpenURL("https://assetstore.unity.com/packages/slug/23634"); }));
            root.Q<Label>("btn_cfxrbundle").AddManipulator(new Clickable(_ => { Application.OpenURL("https://assetstore.unity.com/packages/slug/232385"); }));

            root.Q<Button>("close_dontshow").RegisterCallback<ClickEvent>(_ =>
            {
                root.style.backgroundImage = new StyleBackground(AssetDatabase.LoadAssetAtPath<Texture2D>(AssetDatabase.GUIDToAssetPath("fed1b64fd853f994c8d504720a0a6d44")));
